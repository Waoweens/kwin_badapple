...
pub trait OrgFreedesktopLogin1Manager {
    ...
    fn list_sessions_ex(&self) -> Result<Vec<(String, u32, String, String, u32, String, String, bool, u64, dbus::Path<'static>,)>, dbus::Error>;
    ...
    fn create_session_with_pidfd(&self, uid: u32, pidfd: arg::OwnedFd, service: &str, type_: &str, class: &str, desktop: &str, seat_id: &str, vtnr: u32, tty: &str, display: &str, remote: bool, remote_user: &str, remote_host: &str, flags: u64, properties: Vec<(&str, arg::Variant<Box<dyn arg::RefArg>>,)>) -> Result<(String, dbus::Path<'static>, String, arg::OwnedFd, u32, String, u32, bool), dbus::Error>;
    ...
    fn sleep(&self, flags: u64) -> Result<(), dbus::Error>;
    ...
    fn can_sleep(&self) -> Result<String, dbus::Error>;
    ...
    fn sleep_operation(&self) -> Result<Vec<String>, dbus::Error>;
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgFreedesktopLogin1Manager for blocking::Proxy<'a, C> {
    ...
    fn list_sessions_ex(&self) -> Result<Vec<(String, u32, String, String, u32, String, String, bool, u64, dbus::Path<'static>,)>, dbus::Error> {
        self.method_call("org.freedesktop.login1.Manager", "ListSessionsEx", ())
            .and_then(|r: (Vec<(String, u32, String, String, u32, String, String, bool, u64, dbus::Path<'static>,)>, )| Ok(r.0, ))
    }
    ...
    fn create_session_with_pidfd(&self, uid: u32, pidfd: arg::OwnedFd, service: &str, type_: &str, class: &str, desktop: &str, seat_id: &str, vtnr: u32, tty: &str, display: &str, remote: bool, remote_user: &str, remote_host: &str, flags: u64, properties: Vec<(&str, arg::Variant<Box<dyn arg::RefArg>>,)>) -> Result<(String, dbus::Path<'static>, String, arg::OwnedFd, u32, String, u32, bool), dbus::Error> {
        self.method_call("org.freedesktop.login1.Manager", "CreateSessionWithPIDFD", (uid, pidfd, service, type_, class, desktop, seat_id, vtnr, tty, display, remote, remote_user, remote_host, flags, properties, ))
    }
    ...
    fn suspend_with_flags(&self, flags: u64) -> Result<(), dbus::Error> {
        self.method_call("org.freedesktop.login1.Manager", "SuspendWithFlags", (flags, ))
    }
    ...
    fn hibernate_with_flags(&self, flags: u64) -> Result<(), dbus::Error> {
        self.method_call("org.freedesktop.login1.Manager", "HibernateWithFlags", (flags, ))
    }
    ...
    fn hybrid_sleep_with_flags(&self, flags: u64) -> Result<(), dbus::Error> {
        self.method_call("org.freedesktop.login1.Manager", "HybridSleepWithFlags", (flags, ))
    }
    ...
    fn suspend_then_hibernate_with_flags(&self, flags: u64) -> Result<(), dbus::Error> {
        self.method_call("org.freedesktop.login1.Manager", "SuspendThenHibernateWithFlags", (flags, ))
    }

    fn sleep(&self, flags: u64) -> Result<(), dbus::Error> {
        self.method_call("org.freedesktop.login1.Manager", "Sleep", (flags, ))
    }
    ...
    fn can_sleep(&self) -> Result<String, dbus::Error> {
        self.method_call("org.freedesktop.login1.Manager", "CanSleep", ())
            .and_then(|r: (String, )| Ok(r.0, ))
    }
    ...
    fn sleep_operation(&self) -> Result<Vec<String>, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.freedesktop.login1.Manager", "SleepOperation")
    }
    ...
    fn handle_power_key_long_press(&self) -> Result<String, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.freedesktop.login1.Manager", "HandlePowerKeyLongPress")
    }

    fn handle_reboot_key(&self) -> Result<String, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.freedesktop.login1.Manager", "HandleRebootKey")
    }

    fn handle_reboot_key_long_press(&self) -> Result<String, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.freedesktop.login1.Manager", "HandleRebootKeyLongPress")
    }
    ...
    fn handle_suspend_key_long_press(&self) -> Result<String, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.freedesktop.login1.Manager", "HandleSuspendKeyLongPress")
    }
    ...
    fn handle_hibernate_key_long_press(&self) -> Result<String, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.freedesktop.login1.Manager", "HandleHibernateKeyLongPress")
    }
    ...
    fn stop_idle_session_usec(&self) -> Result<u64, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.freedesktop.login1.Manager", "StopIdleSessionUSec")
    }
